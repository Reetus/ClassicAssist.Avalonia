...
namespace ClassicAssist.Tests.ECV
{
    ...
    public class EntityCollectionFilterGroupTests
    {
        ...
        private static readonly PropertyEntry IdConstraint = new()
        {
            Name = "Test ID",
        ...
        {
            ItemCollection collection = new( 0x40000000 );
        ...
        private static AutolootConstraintEntry IdFilter( AutolootOperator op, int value )
        {
            return new AutolootConstraintEntry { Property = IdConstraint, Operator = op, Value = value };
        }

        private static AutolootConstraintEntry IdFilter( int value )
        {
            return IdFilter( AutolootOperator.Equal, value );
        }

        private static EntityCollectionFilterGroup LeafGroup( params AutolootConstraintEntry[] items )
        {
            return new EntityCollectionFilterGroup { Items = new ObservableCollection<AutolootConstraintEntry>( items ) };
        }

        private static EntityCollectionFilterGroup LeafGroup( BooleanOperation operation,
            params AutolootConstraintEntry[] items )
        {
            return new EntityCollectionFilterGroup
            {
                Operation = operation,
                Items = new ObservableCollection<AutolootConstraintEntry>( items )
            };
        }
        ...
        public void SingleTopLevelGroupOperationIsIgnored()
        {
            ...
            ItemCollection result = EntityCollectionViewerViewModel.EvaluateGroups(
                new List<EntityCollectionFilterGroup> { LeafGroup( BooleanOperation.Not, IdFilter( 0x02 ) ) },
                source );
        ...
        public void MultipleItemsInGroupAreAnded()
        {
            ...
            ItemCollection result = EntityCollectionViewerViewModel.EvaluateGroups(
                ...
                {
                    LeafGroup( IdFilter( AutolootOperator.GreaterThan, 0x02 ),
                        IdFilter( AutolootOperator.LessThan, 0x03 ) )
                },
                source );
        ...
        public void MultipleTopLevelGroupsAreAnded()
        {
            ...
            List<EntityCollectionFilterGroup> groups =
            [
        ...
        public void BranchGroupIgnoresItsOwnItems()
        {
            ...
            group.Items = new ObservableCollection<AutolootConstraintEntry> { IdFilter( 0x01 ) };
        ...
        public void EmptyGroupListReturnsSource()
        {
            ...
            ItemCollection result = EntityCollectionViewerViewModel.EvaluateGroups(
                new List<EntityCollectionFilterGroup>(), source );
