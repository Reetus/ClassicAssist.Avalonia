...
namespace ClassicAssist.Tests
{
    ...
    public class MacroCommandHelpTests
    {
        ...
        [DataRow( "TradeReject" )]
        [DataRow( "ActiveAbility" )]
        [DataRow( "DiffHitsPercent" )]
        [DataRow( "FasterCastRecovery" )]
        [DataRow( "FasterCasting" )]
        [DataRow( "SwingSpeedIncrease" )]
        [DataRow( "Direction" )]
        [DataRow( "Map" )]
        [DataRow( "AutoColorPick" )]
        [DataRow( "ClearObjectQueue" )]
        [DataRow( "DropItemToGround" )]
        [DataRow( "MoveItemXYZ" )]
        [DataRow( "MoveTypeXYZ" )]
        [DataRow( "IsRunning" )]
        [DataRow( "PlaySound" )]
        [DataRow( "StopOrganizer" )]
        [DataRow( "SkillDelta" )]
        [DataRow( "UseLastSkill" )]
        [DataRow( "OpenECV" )]
        [DataRow( "PopList" )]
        [DataRow( "Autoloot" )]
        [DataRow( "Autolooting" )]
        [DataRow( "SetAutoloot" )]
        [DataRow( "SetOrganizerContainers" )]
