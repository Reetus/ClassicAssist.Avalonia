...
namespace ClassicAssist.Launcher.Windows.Interop
{
    ...
    {
        public static readonly Guid CLSID_DestinationList = new Guid( "77F10CF0-3DB5-4966-B520-B7C54FD35ED6" );
        public static readonly Guid CLSID_EnumerableObjectCollection = new Guid( "2D3468C1-36A7-43B6-AC24-D3F02FD9607A" );
        public static readonly Guid CLSID_ShellLink = new Guid( "00021401-0000-0000-C000-000000000046" );

        public static readonly Guid IID_IObjectArray = new Guid( "92CA9DCD-5622-4BBA-A805-5E9F541BD8C9" );
