...
namespace ClassicAssist.Launcher.ViewModels
{
    public class MainViewModel : BaseViewModel
    {
        ...
        public ICommand OptionsCommand => _optionsCommand ?? ( _optionsCommand = new RelayCommandAsync( ShowOptionsWindow, o => true ) );
        ...
        public ICommand SelectClientPathCommand => _selectClientPathCommand ?? ( _selectClientPathCommand = new RelayCommandAsync( SelectClientPath, o => true ) );

        public ICommand SelectDataPathCommand => _selectDataPathCommand ?? ( _selectDataPathCommand = new RelayCommandAsync( SelectDataPath, o => true ) );
        ...
        public ICommand ShowShardsWindowCommand => _showShardsWindowCommand ?? ( _showShardsWindowCommand = new RelayCommandAsync( ShowShardsWindow, o => true ) );
        ...
        private async Task ShowOptionsWindow( object arg )
        {
            ...
            if ( !( window.DataContext is OptionsViewModel vm ) )
            {
                return;
            }
        ...
        private async Task SelectClientPath( object obj )
        {
            ...
            FilePickerFileType[] fileTypes = OperatingSystem.IsWindows()
                ? new[] { new FilePickerFileType( "Client executable" ) { Patterns = new[] { "*.exe" } } }
            ...
            {
                AllowMultiple = false, Title = "Select a client", FileTypeFilter = fileTypes
            } );
        ...
        private async Task SelectDataPath( object obj )
        {
            ...
            {
                AllowMultiple = false, Title = "Select your Ultima Online directory"
            } );
        ...
        private async Task Start( object obj )
        {
            ...
            List<string> pluginList = new List<string> { pluginPath };
        ...
        private async Task ShowShardsWindow( object obj )
        {
            ...
            if ( !( window.DataContext is ShardsViewModel vm ) )
            {
                return;
            }
        ...
        private void Closing( object obj )
        {
            ...
            using ( JsonTextWriter jtw = new JsonTextWriter( new StreamWriter( Path.Combine( AppContext.BaseDirectory, CONFIG_FILENAME ) ) ) )
            {
