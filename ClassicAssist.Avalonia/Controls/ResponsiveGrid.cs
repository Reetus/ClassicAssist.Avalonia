...
namespace ClassicAssist.Avalonia.Controls
{
    ...
    public class ResponsiveGrid : Grid
    {
        ...
        /// </summary>
        [Content]
        public AvaloniaList<Control> Items { get; } = new AvaloniaList<Control>();
        ...
        private void Rebuild()
        {
            ...
            try
            {
                ...
                if ( !_attached )
                {
                    Populate( new List<List<Control>> { Items.ToList() }, false );
                    _attached = true;
                }
            ...
            int maxColumns )
        {
            ...
            Dictionary<Control, Size> sizes = new Dictionary<Control, Size>( Items.Count );
        ...
        {
            List<List<Control>> columns = new List<List<Control>> { new List<Control>() };
        ...
        private void Populate( List<List<Control>> columns, bool overflows )
        {
            ...
            for ( int i = 0; i < columns.Count; i++ )
            {
                ...
                StackPanel stackPanel = new StackPanel { Spacing = Spacing };
