...
namespace ClassicAssist.Avalonia.Misc
{
    ...
    public class AvalonEditCompletionBehaviour : Behavior<TextEditor>
    {
        ...
        {
            List<PythonCompletionData> data = new List<PythonCompletionData>();
        ...
        private void OnTextEntered( object sender, TextInputEventArgs e )
        {
            ...
            List<PythonCompletionData> data = _completionData
                ...
                .GroupBy( m => m.Name ).Select( g => g.First() ).ToList();
            ...
            if ( _completionWindow == null )
            {
                ...
                {
                    CloseWhenCaretAtBeginning = true, CloseAutomatically = false, Width = 500, MaxHeight = 300
                };
        ...
        private string GetWordAt( TextViewPosition position )
        {
            try
            {
                ...
                return end <= start ? null : text.Substring( start, end - start );
            }
            catch ( Exception )
            {
                return null;
