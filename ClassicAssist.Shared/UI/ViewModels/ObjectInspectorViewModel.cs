...
public class ObjectInspectorViewModel : BaseViewModel
{
    ...
    public ICommand CopyToClipboardCommand
    {
        ...
        {
            return field ??=
                new RelayCommand( o => CopyToClipboard(), o => SelectedItem != null );
        }
    }
    ...
    private void AddMobileProperties( Mobile mobile )
    {
        ...
        AddEquipmentProperty( equipment, [1060448, 1153735], [0, 0], "Physical Resist",
            Strings.Resistances );
        AddEquipmentProperty( equipment, [1060447, 1153737], [0, 0], "Fire Resist",
            Strings.Resistances );
        AddEquipmentProperty( equipment, [1060445, 1153739], [0, 0], "Cold Resist",
            Strings.Resistances );
        AddEquipmentProperty( equipment, [1060449, 1153736], [0, 0], "Poison Resist",
            Strings.Resistances );
        AddEquipmentProperty( equipment, [1060446, 1153738], [0, 0], "Energy Resist",
            Strings.Resistances );
    ...
    {
        List<Item> items = [.. mobile.GetEquippedItems()];
    ...
    {
        AddEquipmentProperty( items, [cliloc], [argumentIndex], name, category );
    }
    ...
    private void CopyToClipboard()
    {
        ...
        try
        {
            Engine.UIInvoker?.SetClipboardText( SelectedItem.Value );
        }
        catch ( Exception )
        {
            // ignored
    ...
    {
        Engine.UIInvoker?.Invoke( "DebugWindow", [typeof( DebugPropertiesViewModel ), properties] );
    }
