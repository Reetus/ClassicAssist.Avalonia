...
public class OptionsTabViewModel : BaseViewModel, ISettingProvider
{
    ...
    public ICommand MacrosGumpChangedCommand => field ??= new RelayCommand( MacrosGumpChanged );

    public ICommand SelectMacroTextColorCommand => field ??=
    ...
    public void Serialize( JObject json )
    {
        ...
        JObject useOnce = new() { ["Persist"] = CurrentOptions.PersistUseOnce };

        if ( CurrentOptions.PersistUseOnce )
        {
            JArray useOnceItems = [.. ActionCommands.UseOnceList];
    ...
    private async void SelectMacroTextColor( object obj )
    {
        ...
        MacrosGumpTextColorSelectorViewModel vm = new()
        {
