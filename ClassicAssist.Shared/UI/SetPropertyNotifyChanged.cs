...
public abstract class SetPropertyNotifyChanged : INotifyPropertyChanged
{
    ...
    {
        PropertyChanged?.Invoke( this, _argsCache.GetOrAdd( propertyName, name => new PropertyChangedEventArgs( name ) ) );
    }

    protected virtual void SetProperty<T>( ref T obj, T value, bool skipIfUnchanged = true, Action<T> afterChange = null, [CallerMemberName] string propertyName = "" )
    {
