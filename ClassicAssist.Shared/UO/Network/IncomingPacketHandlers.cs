...
public static class IncomingPacketHandlers
{
    ...
    public delegate void dSkillUpdated( int id, float value, float baseValue, LockStatus lockStatus, float skillCap );
    ...
    private static readonly Version _version6017 = new( 6, 0, 1, 7 );
    ...
    private static void OnDisplayEquipmentInfo( PacketReader reader )
    {
        ...
        Engine.Journal.Write( new JournalEntry { Serial = -1, SpeechType = JournalSpeech.Label, Name = "System", Text = journalOutput } );
    ...
    private static void OnCompressedGump( PacketReader reader )
    {
        ...
        bool success = Compression.Uncompress( ref decompressedBuffer, ref decompressedLength, compressedBuffer, compressedLength );
        ...
        if ( compressedLength > 4 )
        {
            ...
            success = Compression.Uncompress( ref decompressedBuffer, ref decompressedLength, compressedBuffer, compressedLength );
    ...
    private static void OnTarget( PacketReader reader )
    {
        ...
        {
            var obj = Engine.LastTargetQueue.Dequeue();
    ...
    private static void OnItemAddedToContainer( PacketReader reader )
    {
        ...
        int x = reader.ReadInt16();
        int y = reader.ReadInt16();
        int grid = Engine.ClientVersion == null || Engine.ClientVersion >= _version6017 ? reader.ReadByte() : 0;
    ...
    private static void OnProperties( PacketReader reader )
    {
        ...
        {
            Property property = new() { Cliloc = cliloc };

            int length = reader.ReadInt16();

            property.Arguments = reader.ReadUnicodeString( length ).Split( _tabSeparator, StringSplitOptions.RemoveEmptyEntries );
    ...
    {
        int serial = reader.ReadInt32();
        ItemCollection container = new( serial );
    ...
    private static void OnInitializePlayer( PacketReader reader )
    {
        ...
        PlayerMobile mobile = new( serial );
