...
public class PacketWaitEntries
{
    ...
    private readonly List<PacketWaitEntry> _waitEntries = [];
    private readonly Lock _waitEntryLock = new();
    ...
    public bool CheckWait( byte[] packet, PacketDirection direction, bool filteredPacket = false )
    {
        ...
        List<PacketWaitEntry> matchedEntries = [];
        ...
        List<PacketWaitEntry> removeList = [];
