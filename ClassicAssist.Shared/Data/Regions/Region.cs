...
public static class Regions
{
    ...
    private static readonly Lazy<List<Region>> _regions = new( LoadRegions );
    ...
    private static List<Region> LoadRegions()
    {
        ...
        using ( StreamReader sr =
            new( Path.Combine( Engine.StartupPath ?? Environment.CurrentDirectory, "Data",
                "Regions.json" ) ) )
        {
