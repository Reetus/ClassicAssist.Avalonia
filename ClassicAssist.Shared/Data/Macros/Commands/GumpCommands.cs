...
public static class GumpCommands
{
    ...
    public static void OpenVirtueGump( object obj = null )
    {
        ...
        Engine.SendPacketToServer( new GumpButtonClick( 0x1CD, Engine.Player.Serial, 1, [serial] ) );
    }
    ...
    {
        return UO.Gumps.ItemArrayGump.SendGump( [.. items], multiSelect, x, y, fixedSize );
    }
