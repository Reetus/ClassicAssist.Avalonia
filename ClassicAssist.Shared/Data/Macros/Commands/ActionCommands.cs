...
public static class ActionCommands
{
    ...
    [CommandsDisplay( Category = nameof( Strings.Actions ),
        Parameters = new[]
        {
            nameof( ParameterType.SerialOrAlias ), nameof( ParameterType.ItemID ), nameof( ParameterType.Amount ),
    ...
    [CommandsDisplay( Category = nameof( Strings.Actions ),
        Parameters = new[]
        {
            nameof( ParameterType.SerialOrAlias ), nameof( ParameterType.String ), nameof( ParameterType.Timeout )
        } )]
    public static bool WaitForContext( object obj, string entryName, int timeout )
    {
        ...
        PacketFilterInfo pfi = new(0xBF,
            ...
            }, ( bytes, info ) =>
            {
                ...
                if ( entry == null )
                {
                    UOC.SystemMessage( "Context menu entry not found...", 61 );
                    return;
                }
