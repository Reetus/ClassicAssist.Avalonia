...
public class BuffIconManager
{
    ...
    private BuffIconManager()
    {
        ...
        _buffIconData = [.. JsonConvert.DeserializeObject<BuffIconData[]>( File.ReadAllText( Path.Combine( dataPath, "BuffIcons.json" ) ) )];
    ...
    public string[] GetEnabledNames()
    {
        ...
        return [.. enabled.Select( GetDataByID ).Select( data => data?.Name )];
    }
