...
public class AbilitiesManager
{
    ...
    {
        if ( layer is not Layer.OneHanded and not Layer.TwoHanded )
        {
            return;
        }
    ...
    private static void LoadWeaponData( string basePath )
    {
        ...
        _weaponData = [.. JsonConvert.DeserializeObject<WeaponData[]>( File.ReadAllText( Path.Combine( dataPath, "Weapons.json" ) ) )];
    }
