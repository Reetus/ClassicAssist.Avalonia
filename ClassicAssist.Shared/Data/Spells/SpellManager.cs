...
public class SpellManager
{
    ...
    private SpellManager()
    {
        ...
        _spellData = [.. JsonConvert.DeserializeObject<SpellData[]>( File.ReadAllText( Path.Combine( dataPath, "Spells.json" ) ) )];

        _masteryData = [.. JsonConvert.DeserializeObject<SpellData[]>( File.ReadAllText( Path.Combine( dataPath, "Masteries.json" ) ) )];
    }
